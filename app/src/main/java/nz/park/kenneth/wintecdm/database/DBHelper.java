...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void createDatabase(SQLiteDatabase wintecDPM_DB)
    {
        try
        {
            createModules(wintecDPM_DB);
            createPathways(wintecDPM_DB);
            createClients(wintecDPM_DB);
            createStudents(wintecDPM_DB);
            createPathwayModule(wintecDPM_DB);
            createStudentPathway(wintecDPM_DB);
